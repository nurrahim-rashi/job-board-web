...
export default function AdminJobDetailPage() {
  ...
  return (
    ...
    >
      ...
      <ApplicantSection slug={job.slug} salaryCurrency={job.salaryCurrency} hasPreSelectionTest={job.hasPreSelectionTest} testDurationMinutes={job.testDurationMinutes} />
