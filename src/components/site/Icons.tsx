...
export const Trash = icon(
  "M3 6h18M8 6V4h8v2m-11 0 1 15h12l1-15M10 11v6m4-6v6",
);
...
export const Video = icon(
  "M16 10.5 22 7v10l-6-3.5M4 6h10a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Z",
);
export const Github = icon(
  "M15 22v-4a4.8 4.8 0 0 0-1-3.5c3.3-.4 6.8-1.6 6.8-7A5.4 5.4 0 0 0 19.4 4 5 5 0 0 0 19.3.5S18 0 15 2a13.4 13.4 0 0 0-7 0C5 .5 3.7.5 3.7.5A5 5 0 0 0 3.6 4a5.4 5.4 0 0 0-1.4 3.7c0 5.3 3.5 6.5 6.8 7A4.8 4.8 0 0 0 8 18v4M8 19c-3 .9-3-1.5-4-2",
);
...
export const XSocial = icon("M4 4l16 16M20 4 4 20");
export const WhatsApp = icon(
  "M21 11.5a9 9 0 0 1-13.3 7.9L3 21l1.6-4.6A9 9 0 1 1 21 11.5ZM8.3 7.4c.2-.4.5-.4.8-.4h.5c.2 0 .4.1.5.5l.8 2c.1.3.1.5-.1.7l-.7.9c-.2.2-.1.5.1.8 1 1.7 2.3 2.8 4 3.5.3.1.5.1.7-.1l1.1-1.3c.2-.2.4-.3.7-.2l2 .9c.3.1.4.3.4.5-.1.8-.5 1.6-1.1 2.1-.5.4-1.2.7-2.2.5-1.4-.2-3.5-1-5.7-3-1.8-1.7-3-3.8-3.2-5.2-.1-.9.2-1.6.6-2.2Z",
);
export const Globe = icon(
  "M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0 0c2.2-2.7 3.4-6.1 3.4-10S14.2 4.7 12 2c-2.2 2.7-3.4 6.1-3.4 10s1.2 7.3 3.4 10ZM2 12h20",
);
