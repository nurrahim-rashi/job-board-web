...
export const Star = icon("m12 2 3.1 6.3 6.9 1-5 4.9 1.2 6.8L12 17.5 5.8 21l1.2-6.8-5-4.9 6.9-1Z");
export const BadgeCheck = icon("M12 2l2.1 2.1 3-.1.9 2.8 1.8 2.4-2.6 1.5.8 3-3 .7L12 20l-2.7-1.5-3-.7.8-3-2.6-1.5 1.8-2.4-.9-2.8 3 .1L12 2Zm-3 10 2 2 4-4");
export const CreditCard = icon("M3 5h18v14H3ZM3 10h18M7 16h3");
export const Receipt = icon("M5 3h14v18l-2-1.5-2 1.5-3-1.5-3 1.5-2-1.5L5 21ZM8 8h8M8 12h8M8 16h5");
export const ShieldCheck = icon("M12 22s8-3.8 8-10V5l-8-3-8 3v7c0 6.2 8 10 8 10Zm-3.5-10 2.3 2.3 4.8-4.8");
export const SlidersHorizontal = icon("M4 7h16M7 7v0M4 17h16M17 17v0M4 12h16M12 12v0");
